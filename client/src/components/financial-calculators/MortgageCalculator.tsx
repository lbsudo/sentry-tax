            ...
            "
                    ...
                    <div className="text-gray-300 text-lg">
                        <ul className="space-y-2 list-disc ml-5">
                            <li>Which mortgage is better (comparison)</li>
                            <li>Should I pay points?</li>
                            <li>Fixed vs. adjustable?</li>
                            <li>Is refinancing beneficial?</li>
                            <li>How much should I put down?</li>
                            <li>Are extra payments advantageous?</li>
                            <li>How can I pay off my loan early?</li>
          ...
          "
            ...
            "
              ...
              "
                        ...
                        {/* iFrame */}
                        <iframe
                            src="https://www.calculator.net/mortgage-calculator.html"
